      ...
      <div className="home-div-left">
        <div className="top-content">
          ...
          <div class="searchBox">
            ...
            <input class="searchInput" type="text" name="" placeholder="Search Company" value={company} onChange={(e) => setCompany(e.target.value)}/>
            <button class="searchButton" onClick={handleSearch} href="#">
